...
Repository target version is `1.1.1`; `1.0.3` is the latest published on PyPI. Package classifiers declare `Development Status :: 4 - Beta`. (`1.1.0` was TestPyPI-only; superseded by `1.1.1` for production publish.)
