...
- Release-facing docs must describe `1.1.1` as the repository target version and `1.0.3` as the latest published public version; they may claim only the specific publication facts backed by evidence files under `docs/release/`. (`1.1.0` was TestPyPI-only; superseded by `1.1.1`.)
