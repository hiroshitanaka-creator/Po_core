...
class Descartes(Philosopher):
    ...
    def _analyze_cogito(self, text: str) -> Dict[str, Any]:
        ...
        if has_cogito or (
            thinking_count >= 2 and existence_count >= 1 and has_first_person
        ):
            status = "Cogito Achieved"
            description = (
                "Self-awareness of thinking existence - the foundational certainty"
            )
            certainty_level = "Absolute"
        elif thinking_count >= 2 and has_first_person:
            status = "Approaching Cogito"
            description = (
                "Awareness of thinking self, but existence not explicitly connected"
            )
    ...
    def _analyze_methodic_doubt(self, text: str) -> Dict[str, Any]:
        ...
        doubt_score = (
            doubt_count + (2 if has_method else 0) + (2 if questions_all else 0)
        )

        if doubt_score >= 4 and seeks_certainty:
            doubt_type = "Methodic Doubt"
            description = (
                "Systematic doubt as method to reach certainty - Cartesian method"
            )
    ...
    def _analyze_mind_body_dualism(self, text: str) -> Dict[str, Any]:
        ...
        if has_dualism or (mind_count >= 2 and body_count >= 2 and not has_monism):
            ...
            description = (
                "Mind and body as distinct substances - res cogitans and res extensa"
            )
    ...
    def _analyze_innate_ideas(self, text: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "origin": origin,
            "innate_ideas": (
                innate_ideas_found if innate_ideas_found else ["None identified"]
            ),
    ...
    def _analyze_god_as_guarantor(self, text: str) -> Dict[str, Any]:
        ...
        if has_god and has_guarantee and has_perfection:
            ...
            description = (
                "God's perfection guarantees truth of clear and distinct ideas"
            )
    ...
    def _analyze_evil_demon(self, text: str) -> Dict[str, Any]:
        ...
        if has_demon or (has_radical and deception_count >= 2):
            ...
            description = (
                "Contemporary version of evil demon (simulation, brain in vat)"
            )
            doubt_level = "Radical"
    ...
    def _analyze_mathematical_method(self, text: str) -> Dict[str, Any]:
        ...
        method_score = (
            math_count + deduction_count + precision_count + (2 if has_axioms else 0)
        )

        if method_score >= 5 and has_axioms:
            status = "Mathematical Method"
            description = (
                "Geometric/mathematical method applied - axiomatic and deductive"
            )
    ...
    def _calculate_tension(self, analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if epistemic_position == "Empiricism":
            ...
            tension_elements.append(
                "Empiricist stance - contrary to Cartesian rationalism"
            )
