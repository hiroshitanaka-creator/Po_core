...
class Badiou(Philosopher):
    ...
    def _analyze_event_truth(self, prompt: str) -> Dict[str, Any]:
        ...
        reasoning = self._construct_reasoning(
            prompt, event, truth_procedure, fidelity, subject
        )
    ...
    def _apply_badiou_to_problem(self, text: str) -> str:
        """Apply Badiouian concepts to the domain of the given text."""
        t = text.lower()
        if any(
            w in t
            for w in [
            ...
            return (
                "In Badiou's framework, genuine political change is not the gradual reform of "
                "existing structures but the Event: a rare rupture that supplements the prevailing "
                "situation with something previously invisible or unrepresentable within it. "
                "The Paris Commune, May 1968, the Haitian Revolution — these are political Events "
                "because they opened possibilities that the situation declared impossible. "
                "Fidelity to such an Event — the subjective commitment to trace and sustain its "
                "implications against the reaction that always seeks to declare the Event "
                "null and void — is what Badiou calls politics as truth procedure. Generic "
                "communism names the aspiration: a political truth for all, subtracting from "
                "the particular interests of states, parties, and markets."
            )
        elif any(
            w in t
            for w in [
            ...
            return (
                "Love, for Badiou, is one of the four truth procedures — not a fusion of two "
                "into one (the romantic fantasy) nor the mere calculation of mutual advantage, "
                "but the construction of a world from the point of view of Two. The amorous "
                "encounter is an Event: aleatory, unforeseeable, not derivable from any prior "
                "state of the situation. Fidelity to that encounter — the ongoing work of "
                "sustaining the difference that the Two introduces into the world — is love "
                "as truth procedure. Badiou defends a risky love against the 'safety' of "
                "dating algorithms that promise compatibility: the Event cannot be engineered, "
                "and fidelity is its condition, not its guarantee."
            )
        elif any(
            w in t
            for w in [
            ...
            return (
                "Badiou's bold ontological claim — mathematics is ontology — identifies being "
                "qua being with pure, inconsistent multiplicity, formally presented by set "
                "theory. Philosophy does not produce truths but conditions itself on the truths "
                "generated by the four procedures; science (mathematics in particular) is one "
                "of those procedures. The void (the empty set) is the proper name of being: "
                "every consistent presentation of a situation has an unpresentable void at its "
                "core. Generic sets — subsets of a situation that cannot be distinguished by "
                "any property available within the situation — are the ontological structure of "
                "truths: universal, because they belong to no particular part of the situation."
            )
        elif any(
            w in t
            for w in [
            ...
            return (
                "Art is a truth procedure in Badiou's system: not a representation of the world "
                "but a production of truths through the making of works. An artistic Event — "
                "the appearance of a genuinely new artistic configuration that shatters the "
                "established aesthetic regime — is as rare and demanding as a political revolution. "
                "Mallarmé's poetry, Schoenberg's twelve-tone method, Beckett's theatre: these "
                "are Events to which fidelity is owed. Badiou's own work on Beckett and "
                "Mallarmé demonstrates that philosophy can 'condition' itself on artistic "
                "truth procedures, thinking with and from the formal operations of art rather "
                "than merely using art as illustration."
            )
        elif any(
            w in t
            for w in [
            ...
            return (
                "The subject, for Badiou, is not a pre-given entity but constituted by fidelity "
                "to an Event. Before the Event, there is no subject — only an individual within "
                "the situation. The Event interpellates a subject by demanding a decision: will "
                "you be faithful to what has happened? Subjective truth is not a state achieved "
                "once and held, but a process — the ongoing, indefinite work of drawing out "
                "the consequences of the Event within the situation, against the situation's "
                "tendency to deny or absorb the Event. Fidelity is costly, unending, and "
                "irreducible to calculation — it is the form of the infinite in finite existence."
            )
        elif any(
            w in t
            for w in [
            ...
            return (
                "Badiou insists on truth against the dominant sophistry that reduces all claims "
                "to opinion, perspective, or language games. Truths are real but rare: they "
                "emerge from Events in the four domains (politics, love, science, art) and are "
                "characterized by universality (they are for everyone, not for a particular "
                "community), genericness (they cannot be defined by any predicate within the "
                "situation), and eternity (once produced, they remain true). Opinion (doxa) "
                "— the currency of media, democracy, and the market — is the constitutive "
                "enemy of truth procedures. Philosophy's task is to declare: truths exist, "
                "and they matter more than consensus."
            )
        else:
            return (
                "Badiou's philosophy is organized around four key concepts: the Event (a rare "
                "rupture that supplements a situation with the previously unrepresentable), "
                "fidelity (the subjective commitment to tracing the Event's consequences), "
                "truth procedure (the ongoing process of a truth — in politics, love, science, "
                "or art), and subjectivation (the constitution of a Subject through faithful "
                "engagement). Mathematics is ontology: being qua being is pure inconsistent "
                "multiplicity, formally captured by set theory. The void — what every situation "
                "cannot present — is the proper name of being. Against relativism, Badiou "
                "defends the existence of universal, generic truths. Being and Event and "
                "Logics of Worlds are the systematic treatises; The Communist Hypothesis "
                "applies the framework politically."
            )
    ...
    def _construct_reasoning(
        ...
        applied = self._apply_badiou_to_problem(prompt)
        reasoning = (
            f"{applied}\n\n"
