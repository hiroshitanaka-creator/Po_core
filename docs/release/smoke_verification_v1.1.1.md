...
See `docs/release/smoke_verification_v1.0.3.md` for the reference pattern of a completed evidence file.
See `docs/release/release_candidate_handoff_v1.1.1.md` for the pre-publish operator checklist.

## v1.1.0 note

`v1.1.0` was published to TestPyPI only (SHA `c94a390`, 2026-04-30). It was not published to PyPI
production and is superseded by `1.1.1`. See `docs/release/release_decision_v1.1.0.md` for details.
