...
- Python package release SSOT remains `src/po_core/__init__.py` (`1.1.1` in this repo snapshot; `1.0.3` is the latest published on PyPI). `1.1.0` was TestPyPI-only (superseded); `1.1.1` is the planned production publish target.
